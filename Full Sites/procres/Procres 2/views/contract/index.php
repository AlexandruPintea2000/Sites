	...
	<body>
		...
		<div class="center" >
			...
			if ( $_SESSION[ 'type' ] == "admin" )
				echo "<h3> Obsolete / Done contracts: Delete <br> <span style=\"font-size: 14px;\"> ( add to \"Deleted Contracts\" only when sure ) </span> </h3>";
	    ...
	    if ( $_SESSION[ 'type' ] == "admin" )
	    {
			echo "<a style=\"margin-left: 2.5%;\" title=\"Deleted Contracts\" href=\"index.php?path=contract_controller/view_deleted_contracts\" > Deleted Contracts</a> / ";
			echo "<a title=\"Make Contract\" href=\"index.php?path=contract_controller/create\" > Make Contarct</a>";
	    }
