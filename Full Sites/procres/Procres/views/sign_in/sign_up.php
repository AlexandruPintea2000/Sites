		...
		<div class="center" >
			...
			<h1> Sign Up </h1>
		        ...
		        <form action="views/sign_in/sign_up.php" style="margin-left: 40%">
		            ...
		            <b> Initialization Id: </b> <input type="number" name="id" placeholder="id" value=<?php if ( isset( $this->data[ 'initialization_id' ] ) ) echo $this->data[ 'initialization_id' ]; ?> > </input>

		             <br> <span style="font-size: 14px;"> ( Sent to you by an admin of <?php echo $this->data[ 'company' ]; ?> ) </span> <br> <br>
...
<!-- 					<span> Wrong type could lead to data loss. </span>

					<br>

		            <span style="font-size: 10px;"> ( using the wrong type could only be fixed by an admin ) </span>
 -->
		            <br> <br>
