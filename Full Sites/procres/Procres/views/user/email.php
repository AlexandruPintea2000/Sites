	...
	<body>
		...
		<div class="center" >
	        ...
	        <form action="views/user/email.php" >
	        	...
	        	<b style="margin-right: 40px">To:</b>  <input style="width: 250px;" type="text" name="email_address"  placeholder="Email Address" value=<?php echo $this->data[ 'email' ]; ?> required> </input> <br>
