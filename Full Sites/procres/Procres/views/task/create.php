...
<html>
	...
	<head>
		<title> Add User to a Part </title>
	...
	<body>
		...
		<div class="center" >
			...
			<h1> Add User to a Part of a Contract </h1>
	    ...
	    <div class="div_center" >
	        ...
	        <form action="views/task/create.php" style="background-color: rgb( 243, 243, 243 ); padding: 10px 5% 10px 5%; border: 3px solid rgb( 204, 204, 204 ); border-radius: 10px;" >
	            ...
	            ?>
	             ...
	             - <a href="index.php?path=user_controller/create/employee"> Add User </a> /
	               <a href="index.php?path=contract_controller"> View Contracts</a> <br>
	            ...
	            ?>
	             ...
	             - <a href="index.php?path=contract_controller/create"> Add Contract</a> /
	               <a href="index.php?path=part_controller/create"> Add Parts </a>  
