...
<html>
	...
	<head>
		<title> Edit User as Part of a Contract </title>
	...
	<body>
		...
		<div class="center" >
			...
			<h1> Edit User as Part of a Contract <br><span style="font-size: 14px;"> ( you should only edit if you got the user or the part wrong )</span> </h1>

	    </div>


	        <form action="views/task/edit.php" style="background-color: rgb( 243, 243, 243 ); padding: 10px 70px 10px 70px; border: 3px solid rgb( 204, 204, 204 ); border-radius: 10px;" >
			...
			<a style="margin-left: 7%;" href=<?php echo "index.php?path=task_controller/view/" . $this->data[ 'id' ]; ?> > Return to user tasks </a>
