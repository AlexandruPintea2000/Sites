...
function remove_separators( string $a )
{
	$i = 0;
	...
	class Database
	{
		...
		public function make_table ( string $table_name, $columns=[], $types=[] )
		{
		...
		public function sql ( $custom_sql = null )
		{
			if ( $custom_sql == null )
				return;

			$this->connection->query( $custom_sql );
		}
	}
