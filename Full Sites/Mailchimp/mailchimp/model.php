<?php
	...
	class Database
	{
		...
		public function database_remake( Database $db )
		{
			$this->__construct( $db->get_servername(), $db->get_username(), $db->get_password(), $db->get_dbname() );
		}
	...
	class Table extends Database
	{
		...
		public function table_remake( Table $table )
		{
			$this->__construct( $table->get_name(), $table->get_database() );
		}
